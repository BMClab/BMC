...
def _(mo):
    ...
    Python is also the name of the software with the most-widely used implementation of the language (maintained by the [Python Software Foundation](http://www.python.org/psf/)).<br>
    This implementation is written mostly in the *C* programming language and it is nicknamed CPython.<br>
...
def _(mo):
    ...
    The origin of the name for the Python language in fact is not because of the big snake, the author of the Python language, Guido van Rossum, named the language after Monty Python, a famous British comedy group in the 70's.<br>
...
def _(mo):
    ...
    Python is not the best programming language for all needs and for all people. There is no such language.<br>
...
def _(mo):
    ...
    You might want an Integrated Development Environment (IDE) for programming in Python.<br>
