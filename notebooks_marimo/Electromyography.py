...
def _(mo):
    mo.md(r"""
    The integrals above are single numbers, the total area under the EMG curve.<br>
...
def _(mo):
    mo.md(r"""
    As the raw EMG signal has zero mean, one is usually interested in the area under the curve of the linear envelope.<br>
...
def _(mo):
    mo.md(r"""
    Note that the 'Vs' above is not the plural of V; it's Volts times seconds.<br>
