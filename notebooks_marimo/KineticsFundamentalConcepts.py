...
def _(mo):
    mo.md(r"""
    Kinetics is the branch of classical mechanics that is concerned with the relationship between the motion of bodies and its causes, namely forces and torques ([Encyclopædia Britannica Online](https://www.britannica.com/science/kinetics)).<br>
...
def _(mo):
    ...
    - **Third law**: Whenever an object exerts a force$\vec{F}_1$(action) on a second object, this second object simultaneously exerts a force$\vec{F}_2$on the first object with the same magnitude but opposite direction (reaction):$\vec{F}_2 = −\vec{F}_1.$These three statements are astonishing in their simplicity and how much of knowledge they empower.<br>
    ...
    > LAW I.<br>
    > *Every body perseveres in its state of rest, or of uniform motion in a right line, unless it is compelled to change that state by forces impressed thereon.*<br>
    > LAW II.<br>
    > *The alteration of motion is ever proportional to the motive force impressed; and is made in the direction of the right line in which that force is impressed.*<br>
    > LAW III.<br>
    ...
    > DEFINITION I.<br>
    > *The quantity of matter is the measure of the same, arising from its density and bulk conjunctly.*<br>
    > ...It is this quantity that I mean hereafter everywhere under the name of body or mass.<br>
    > DEFINITION II.<br>
    > *The quantity of motion is the measure of the same, arising from the velocity and quantity of matter conjunctly.*<br>
    > The motion of the whole is the sum of the motions of all the parts; and therefore in a body double in quantity, with equal velocity, the motion is double; with twice the velocity, it is quadruple.<br>
    > DEFINITION IV.<br>
...
def _(mo):
    ...
    In mechanics, forces can be classified as either contact or body forces. The contact force acts at the point of contact between two bodies. The body force acts on the entire body with no contact (e.g., gravity and electromagnetic forces).<br>
