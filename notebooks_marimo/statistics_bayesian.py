...
def _(mo):
    ...
    Suppose you test positive for a rare disease, with 0.1% of frequency of occurrence in the population.<br>
    ...
    The two events are: having the disease ($A$) and the positive result ($B$).<br>
...
def _(mo):
    mo.md(r"""
    Given that the probability that you have the disease is only 10%, you decide to do another test. In statistical terms, this second test should be independent of the first test.<br>
