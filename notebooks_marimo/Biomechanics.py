...
def _(mo):
    ...
    Although the term Biomechanics may sound new to you, it's not rare that people think the use of methods outside the realm of Mechanics as Biomechanics.<br>
...
def _(mo):
    ...
    Even seeing Biomechanics as a field of Science, as argued by Hatze, it's also possible to refer to Engineering Biomechanics considering that<br>
    *Engineering is the application of scientific and mathematical principles to practical ends* [[The Free Dictionary](http://www.thefreedictionary.com/engineering)] and particularly that<br>
    *Engineering Mechanics is the application of Mechanics to solve problems involving common engineering elements* [[Wikibooks]](https://en.wikibooks.org/wiki/Engineering_Mechanics), and, last but not least, that<br>
...
def _(mo):
    ...
    (Classical) Mechanics is typically partitioned in Statics and Dynamics (Hibbeler, 2012; Ruina and Rudra, 2019).<br>
    In turn, Dynamics is divided in **Kinematics** and **Kinetics**.<br>
...
def _(mo):
    ...
    At the university level, the study of Mechanics is typically done in the disciplines Statics and Dynamics (rigid-body mechanics), Strength of Materials (deformable-body mechanics), and Mechanics of Fluids (fluid mechanics).<br>
...
def _(mo):
    ...
    Aristotle clearly already knew what we nowadays refer as Newton's third law of motion:<br>
