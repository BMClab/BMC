...
def _(mo):
    ...
    <figure><img src="https://github.com/BMClab/BMC/blob/master/images/equivalentSystem.png?raw=1" width=800/></figure>
    """)
    return
...
def _(mo):
    ...
    <figure><img src="https://github.com/BMClab/BMC/blob/master/images/bar1.png?raw=1" width=150 /></figure>
    """)
    return
...
def _(mo):
    ...
    <figure><img src="https://github.com/BMClab/BMC/blob/master/images/bar1FBD.png?raw=1" width=250 /></figure>
    """)
    return
...
def _(mo):
    ...
    <figure><img src="https://github.com/BMClab/BMC/blob/master/images/ballRotDrag.png?raw=1" width=250 /></figure>
    """)
    return
...
def _(mo):
    ...
    <figure><img src="https://github.com/BMClab/BMC/blob/master/images/invertedPendulumFBD.png?raw=1" width=300 /></figure>
    """)
    return
...
def _(mo):
    ...
    <figure><img src="https://github.com/BMClab/BMC/blob/master/images/quietStandingFBD.png?raw=1" width=300 /></figure>
    """)
    return
...
def _(mo):
    ...
    <br>
    <figure><img src="https://github.com/BMClab/BMC/blob/master/images/forcePlatform2DS.png?raw=1" width=250 /></figure>
    """)
    return
...
def _(mo):
    ...
    <figure><img src="https://github.com/BMClab/BMC/blob/master/images/rocker.png?raw=1" width=450 /></figure>
    """)
    return
...
def _(mo):
    ...
    <figure><img src="https://github.com/BMClab/BMC/blob/master/images/doublePendulum.png?raw=1" width=350 /></figure>
    """)
    return
...
def _(mo):
    ...
    <figure><img src="https://github.com/BMClab/BMC/blob/master/images/doublePendulumFBD.png?raw=1" width=700 /></figure>
    """)
    return
