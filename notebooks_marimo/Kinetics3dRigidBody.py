...
def _(mo):
    ...
    > Laboratory of Biomechanics and Motor Control ([http://pesquisa.ufabc.edu.br/bmclab](http://pesquisa.ufabc.edu.br/bmclab))<br>
...
def _(mo):
    ...
    \begin{align}
        \begin{split}
            ...
            M_{O_3} + MFocm_3 &= I_3\dot{\omega_3} + \omega_1\omega_2(I_2-I_1) \rightarrow M_{O_3} &= I_3\dot{\omega_3} + \omega_1\omega_2(I_2-I_1) -  MFocm_3<br>
        \end{split}
    \end{align}
    <span class="notranslate">
